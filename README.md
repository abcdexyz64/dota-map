...
```cfg
alias +dota_map_prediction "say 已经预测他们队伍将取得胜利！"
alias -dota_map_prediction "say 已经连续6657次成功预测了胜利。"
bind "KP_MULTIPLY" "+dota_map_prediction"
alias +dota_map_abandon "say SurrenderAdvisor由于长时间没有重连至游戏，系统判定他为逃跑。"
alias -dota_map_abandon "say 剩余玩家可以自由退出。"
